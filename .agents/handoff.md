...
**Next: Phase 3** (`lib/` consolidation — mostly Sonnet-tier), then Phase 4's remaining performance work. Note Phase 4's P4.3 (benchmarking) is now a prerequisite worth doing early: three phases of load-path changes have landed with no measurements taken.
